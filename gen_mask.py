...
def create_speed_mask():
    ...
    speed_world = [
        (2.9946084022521973, 0.9779025912284851),  # top-left
        (3.016167163848877, -1.020748496055603),  # top-right
        (1.9959399700164795,  -0.9840879440307617),  # bottom-right
        (1.995314598083496,  0.9934210777282715),   # bottom-left
    ]
